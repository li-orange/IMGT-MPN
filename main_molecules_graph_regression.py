...
def preprocess_dataset(dataset, model_name, net_params, t0):
    ...
    # 添加位置编码
    if model_name in ['GatedGCN', 'PNA', 'MPNN'] and net_params.get('pos_enc', False):
...
def main():    
    ...
    """
    #    config_file_names:
    #       molecules_graph_regression_GatedGCN_TOX21_6k.json
    #       molecules_graph_regression_GatedGCN_HIV_40K.json
    #       molecules_graph_regression_GatedGCN_ClinTox_1k5.json
    #       molecules_graph_regression_GatedGCN_BBBP_2k.json
    #       molecules_graph_regression_GatedGCN_BACE_1k5.json
    config_file_path = '/home/zsy123/benchmarking-gnns-master/configs/molecules_graph_regression_GatedGCN_TOX21_6k.json'
    ...
    parser.add_argument('--config', default='/home/zsy123/benchmarking-gnns-master/configs/molecules_graph_regression_GatedGCN_TOX21_6k.json',help="Please give a config.json file with training/model/data/param details")
